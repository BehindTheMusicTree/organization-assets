...
import {
  ...
  GTMT_API_GITHUB_URL,
  GTMT_FRONT_GITHUB_URL,
  TMD_ADMIN_GITHUB_URL,
  ORG_PYPI_URL,
  ORG_LINKEDIN_URL,
  ORG_X_URL,
  ORG_MASTODON_URL,
...
const ENV_ROWS: BuildEnvRow[] = [
  ...
  {
    category: "GitHub",
    usage: "GitHub org link",
    keyName: "ORG_GITHUB_URL",
    keyValue: "ORG_GITHUB_URL",
    inlinedName: "ORG_GITHUB_URL",
    inlinedValue: ORG_GITHUB_URL,
  },
  {
    category: "GitHub",
  ...
  },
  {
    ...
    keyValue: "TMD_ADMIN_API_GITHUB_URL",
    inlinedName: "TMD_ADMIN_API_GITHUB_URL",
    inlinedValue: TMD_ADMIN_API_GITHUB_URL,
  },
  {
    category: "GitHub",
    usage: "GTMT API GitHub link",
    keyName: "GTMT_API_GITHUB_URL",
    keyValue: "GTMT_API_GITHUB_URL",
    inlinedName: "GTMT_API_GITHUB_URL",
    inlinedValue: GTMT_API_GITHUB_URL,
  },
  {
    category: "GitHub",
    usage: "GTMT front GitHub link",
    keyName: "GTMT_FRONT_GITHUB_URL",
    keyValue: "GTMT_FRONT_GITHUB_URL",
    inlinedName: "GTMT_FRONT_GITHUB_URL",
    inlinedValue: GTMT_FRONT_GITHUB_URL,
  },
  {
    category: "GitHub",
    usage: "TMD Admin GitHub link",
    keyName: "TMD_ADMIN_GITHUB_URL",
    keyValue: "TMD_ADMIN_GITHUB_URL",
    inlinedName: "TMD_ADMIN_GITHUB_URL",
    inlinedValue: TMD_ADMIN_GITHUB_URL,
  },
  {
    ...
    inlinedName: "ORG_PYPI_URL",
    inlinedValue: ORG_PYPI_URL,
  },
  {
    category: "Social links",
    ...
    inlinedName: "ORG_LINKEDIN_URL",
    inlinedValue: ORG_LINKEDIN_URL,
  },
  {
    category: "Social links",
    usage: "X social link",
    keyName: "ORG_X_URL",
    keyValue: "ORG_X_URL",
    inlinedName: "ORG_X_URL",
    inlinedValue: ORG_X_URL,
  },
  {
    category: "Social links",
    ...
    inlinedName: "ORG_MASTODON_URL",
    inlinedValue: ORG_MASTODON_URL,
  },
  {
    category: "Social links",
    ...
    inlinedName: "ORG_YOUTUBE_URL",
    inlinedValue: ORG_YOUTUBE_URL,
  },
  {
    category: "Social links",
    ...
    inlinedName: "ORG_SPOTIFY_URL",
    inlinedValue: ORG_SPOTIFY_URL,
  },
  {
    category: "Social links",
    ...
    inlinedName: "ORG_DISCORD_URL",
    inlinedValue: ORG_DISCORD_URL,
  },
  {
    category: "Social links",
    ...
    inlinedName: "ORG_TIPEEE_URL",
    inlinedValue: ORG_TIPEEE_URL,
  },
  {
    category: "Social links",
