...
/** GitHub Sponsors mark (Simple Icons, CC0). */
export function IconGitHubSponsors({ className }: { className?: string }) {
  return (
...
export function IconPypi({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
/** Mastodon mark (Simple Icons, CC0). */
...
/** Spotify mark (Simple Icons, CC0). */
export function IconSpotify({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
